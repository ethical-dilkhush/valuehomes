...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="#">Forgot Password?</a>  <a class="underlineHover" href="login.php">Log In</a>
...
{	 
    //getting values from form variables in register process
    ...
    else
    {
        ...
        $sql = "INSERT INTO users VALUES ('$getid','$user_name','$password','$email')";
