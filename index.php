...
<?php
        ...
        if(isset($_POST['login']))
        {
            ...
            $query = "SELECT * from users where user_name='$uname' && password='$pass'";
...
?>
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="#">Forgot Password?</a>  <a class="underlineHover" href="signup.php">Sign Up</a>
